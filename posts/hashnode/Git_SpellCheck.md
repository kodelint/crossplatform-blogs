...
Every time I’d push a branch and open a `pull request`, I’d see my own mistakes staring back at me from the beautifully crafted UI of **GitHub** or **GitLab**. It was a tiny, public testament to my carelessness. Linters protect my code, but nothing was _**protecting**_ my prose.
